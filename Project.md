...
- پس از پیاده سازی مقدمات اولیه کد (کلاس بندی و خواندن از فایل) ، قبل از شروع پیاده سازی رویداد ها،  پروژه را کامیت کنید.
...
- تمیزی کد شامل کلاس بندی درست ، نام گذاری صحیح متد ها و متغیرها ، داشتن متد مین کوتاه و استفاده از توابع بصورت صحیح
