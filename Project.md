...
- پس از پیاده سازی اولیه مقدمات کد قبل از شروع پیاده سازی های رویداد ها پروژه را کامیت کنید. سپس پس از پیاده سازی هر رویداد و تست کامل از نحوه صحیح عملکرد آن، آن را با پیغام مناسب کامیت کنید.
